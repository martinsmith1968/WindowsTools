...
namespace WinHider
{
  ...
  public class Window
  {
    ...
    [DllImport("user32.dll")] private static extern int SetWindowText(int hWnd, StringBuilder title, int size);
    [DllImport("user32.dll")] private static extern bool SetWindowText(IntPtr hWnd, String strNewWindowName);
  ...
  public class Windows : IEnumerable, IEnumerator
  {
    ...
    [DllImport("user32.dll", EntryPoint="GetWindowModuleFileNameA")] private static extern int GetWindowModuleFileName(int hWnd, StringBuilder title, int size);
    ...
    [DllImport("user32.dll")] private static extern bool IsWindowVisible(int hWnd);
        [DllImport("user32")] private static extern UInt32 GetWindowThreadProcessId(Int32 hWnd, out Int32 lpdwProcessId);
